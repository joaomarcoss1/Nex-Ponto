...
const requiredFiles = [
  ...
  "supabase/migrations/053_nexponto_v53_final_production_remediation.sql",
  ...
  "src/app/api/internal/readiness/route.ts",
  "src/app/api/admin/justifications/attachment/route.ts",
...
const checks = [
  ...
  ["storage privado v53", read("supabase/migrations/053_nexponto_v53_final_production_remediation.sql").includes("storage_private_select_v53")],
  ["quarentena de anexos", read("supabase/migrations/053_nexponto_v53_final_production_remediation.sql").includes("pending_scan")],
  ["URL assinada dedicada", read("src/app/api/admin/justifications/attachment/route.ts").includes("createSignedUrl")],
  ["health publico minimo", !read("src/app/api/health/route.ts").includes("background_jobs")],
  ["testes Storage A/B", read("tests/integration/multitenancy-rls.test.ts").includes("Storage A/B")],
