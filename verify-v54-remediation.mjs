...
const checks = [
  ...
  ["Login sem challenge adicional", !read("src/components/admin/AdminLogin.tsx").includes("auth.mfa")],
  ["Shell sem redirect de segundo fator", !read("src/components/admin/AdminShell.tsx").includes("seguranca-mfa")],
