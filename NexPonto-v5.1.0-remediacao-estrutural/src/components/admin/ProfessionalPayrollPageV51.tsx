      ...
      <div className="space-y-4 pb-28 md:pb-8">
        <section className="overflow-hidden rounded-[1.75rem] bg-gradient-to-br from-[#07162f] via-[#0b2d61] to-[#1152a7] p-5 text-white shadow-[0_30px_90px_rgba(5,25,65,0.25)] sm:p-7">
          <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <p className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em]"><ShieldCheck className="h-3.5 w-3.5" /> Motor profissional v5.1</p>
              <h1 className="mt-4 text-3xl font-black tracking-[-0.04em] sm:text-4xl">Pré-folha e conferência de jornada</h1>
              <p className="mt-2 max-w-3xl text-sm font-semibold leading-6 text-blue-100 sm:text-base">Modo de simulação e homologação, com jornada histórica, rubricas, banco de horas normalizado, divergências e aprovações segregadas.</p>
            </div>
