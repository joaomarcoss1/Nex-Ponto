...
export default function PlatformPage() {
  ...
  async function createTenant() {
    ...
    try {
      const result = await adminFetch<{ tenant: Tenant; inviteSent: boolean }>("/api/platform/tenants", { method: "POST", body: JSON.stringify(form) });
      setMessage(`Empresa ${result.tenant.display_name} criada. O convite do proprietário foi enviado.`);
