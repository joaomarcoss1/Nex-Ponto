...
export function formatDateTimeInput(value: string | Date | null | undefined, timeZone = "America/Fortaleza") {
  if (!value) return "";
  const date = typeof value === "string" ? new Date(value) : value;
...
export function localDateTimeToIso(value: string, timeZone = "America/Fortaleza") {
