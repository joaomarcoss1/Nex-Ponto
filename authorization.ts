...
const ROLE_PERMISSIONS: Record<AdminRole, readonly Permission[]> = {
  ...
  hr_manager: [
    ...
    "overtime.review", "time_bank.manage", "payroll.view", "payroll.calculate",
  ...
  rh_analyst: [
    ...
    "time_bank.manage", "payroll.view", "reports.export",
  ],
  finance_admin: [
    "overtime.review", "time_bank.manage", "payroll.view", "payroll.calculate",
    "payroll.approve", "payroll.resolve_divergence", "payroll.financial_approve",
  ...
  regional_manager: [
    "branch.manage", "employee.manage", "schedule.manage", "time_entry.review",
    "overtime.review", "time_bank.manage", "reports.export",
  ],
  branch_manager: [
    "employee.manage", "schedule.manage", "time_entry.review", "overtime.review",
    "time_bank.manage", "reports.export",
  ],
  department_leader: ["schedule.manage", "time_entry.review", "overtime.review"],
