...
Guia de instalacao e configuracao: [INICIAR_NO_VSCODE.md](INICIAR_NO_VSCODE.md).
Resultados e pendencias da auditoria: [FINAL_PRODUCTION_REPORT.md](FINAL_PRODUCTION_REPORT.md).
